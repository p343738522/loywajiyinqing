...
namespace GameSvr
{
    ...
    public class CastleDoor : GuardUnit
    {
        ...
        public void Close()
        {
            ...
            m_btDirection = (byte)(3 - HUtil32.Round((double)m_WAbil.HP / m_WAbil.MaxHP * 3.0));
        ...
        {
            // sub_684AB8 (TCastleDoor VMT 0x6841AC slot +0x84): inherited death at
            // 0x684AC0, then 0x684AC5 GetTickCount / 0x684ACA mov [ebx+0x4E4],eax
            // starts the dead-structure repair clock, then 0x684AD4 with dl=2.
            base.Die();
        ...
        public override void Run()
        {
            ...
            if (!m_boOpened)
            {
                int n08 = 3 - HUtil32.Round((double)m_WAbil.HP / m_WAbil.MaxHP * 3.0);
        ...
        {
            var n08 = 3 - HUtil32.Round((double)m_WAbil.HP / m_WAbil.MaxHP * 3.0);
            if (n08 - 3 >= 0)
            {
                n08 = 0;
            }
